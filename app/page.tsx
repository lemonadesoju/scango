  ...
  return (
    <div style={{ opacity: 0 }}>
      <div className="flex flex-col min-h-screen">
        {/* Canvas Background */}
        <canvas className="fixed inset-0 bg-[#0A0B1A] -z-10"></canvas>
        ...
        <div className="relative flex-1">
          ...
          <main className="min-h-screen pb-32">
            <div className="flex flex-col items-center justify-center px-4 sm:px-6 pt-20">
              {/* Hero Section */}
              <div className="text-center max-w-4xl z-10 w-full relative" style={{ opacity: 0, transform: 'translateY(20px)' }}>
                <h1 className="text-3xl sm:text-4xl lg:text-6xl font-semibold text-white mb-4 sm:mb-6 leading-tight tracking-tight">
                  ระบบจัดการคุณภาพ
                  <div className="overflow-hidden h-12 sm:h-16 lg:h-24" style={{ opacity: 0, filter: 'blur(8px)', transform: 'translateY(20px)' }}>
                ...
                <p className="text-gray-400 text-sm sm:text-base lg:text-xl mb-8" style={{ opacity: 0 }}>
                  ยกระดับการบริหารจัดการผู้เยี่ยมชมด้วยระบบ QR Code อัตโนมัติ
                </p>
                
                {/* Search Box */}
                <div className="bg-gray-900/95 backdrop-blur-lg rounded-2xl p-6 sm:p-8 max-w-3xl mx-auto shadow-xl" style={{ opacity: 0, transform: 'translateY(20px)' }}>
            ...
            {/* Image Carousel */}
            <div className="mt-24">
              <div className="w-full mx-auto mt-4 sm:mt-8 mb-4 sm:mb-8 px-2 sm:px-4 lg:px-6" style={{ opacity: 0, transform: 'translateY(20px)' }}>
          ...
          <div className="mb-6 text-center">
            <div className="inline-block bg-[#6C63FF]/10 px-4 py-2 rounded-full mb-2">
              <div className="flex items-center justify-center gap-2 text-[#6C63FF]">
                ...
                <span className="font-semibold text-sm">ระบบจัดการผู้เยี่ยมชม</span>
              </div>
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Dashboard การเข้าออก</h2>
            <p className="text-gray-400 text-sm sm:text-base max-w-2xl mx-auto mb-6">
              ติดตามและจัดการการเข้าออกของผู้เยี่ยมชมได้แบบเรียลไทม์ พร้อมระบบรายงานที่ครอบคลุม
            </p>
          </div>

          {/* Action Buttons */}
          <div className="bg-gray-900/95 backdrop-blur-lg rounded-2xl p-4 sm:p-6 mb-20 shadow-xl">
        ...
        <div className="w-full overflow-hidden py-8 bg-gray-900/60 backdrop-blur-lg">
          <div className="flex whitespace-nowrap animate-scroll">
            <div className="inline-flex items-center mx-4">
              <span className="text-4xl font-bold text-[#6C63FF]">Check-In</span>
              <span className="text-[#6C63FF] text-4xl mx-4">✦</span>
            </div>
            <div className="inline-flex items-center mx-4">
              <span className="text-4xl font-bold text-white/20">Security</span>
              <span className="text-[#6C63FF] text-4xl mx-4">✦</span>
            </div>
            <div className="inline-flex items-center mx-4">
              <span className="text-4xl font-bold text-[#6C63FF]">QR Code</span>
              <span className="text-[#6C63FF] text-4xl mx-4">✦</span>
            </div>
            <div className="inline-flex items-center mx-4">
              <span className="text-4xl font-bold text-white/20">Visitor</span>
              <span className="text-[#6C63FF] text-4xl mx-4">✦</span>
            </div>
            <div className="inline-flex items-center mx-4">
              <span className="text-4xl font-bold text-[#6C63FF]">Management</span>
              <span className="text-[#6C63FF] text-4xl mx-4">✦</span>
            </div>
            <div className="inline-flex items-center mx-4">
              <span className="text-4xl font-bold text-white/20">Digital</span>
              <span className="text-[#6C63FF] text-4xl mx-4">✦</span>
            </div>
          </div>
        </div>
        ...
        <section className="py-24 px-4 overflow-hidden">
          <div className="max-w-6xl mx-auto" style={{ opacity: 0 }}>
            <div className="text-center max-w-3xl mx-auto mb-20">
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-4 rounded-full bg-gray-900/50 backdrop-blur-sm shadow-sm border border-gray-800/50">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-[#6C63FF]">
                  <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path>
                </svg>
                <span className="text-sm font-medium text-white">คุณสมบัติเด่น</span>
              </div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                ทำไมถึงควรเลือก ScanGo?
              </h2>
        ...
        >
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1 md:mr-2">
              <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
              <circle cx="9" cy="7" r="4"></circle>
              <path d="m19 8 2 2-2 2"></path>
              <path d="m17 10 2 2-2 2"></path>
            </svg>
            <span className="text-sm md:text-base font-medium">ลงทะเบียนเลย</span>
          </div>
        </Link>
      </div>
